...
with DAG(
    ...
    def extract_data():
        ...
        try:
            ...
            temp_path = '/opt/airflow/data/temp/etl_pipeline_139456_extracted.parquet'
    ...
    def transform_data():
        ...
        try:
            ...
            df['processing_batch_id'] = 'etl_pipeline_139456'
            ...
            transformed_path = '/opt/airflow/data/temp/etl_pipeline_139456_transformed.parquet'
