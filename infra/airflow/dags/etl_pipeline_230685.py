...
with DAG(
    ...
    def extract_data():
        ...
        try:
            ...
            temp_path = '/opt/airflow/data/temp/etl_pipeline_230685_extracted.parquet'
    ...
    def transform_data():
        ...
        try:
            ...
            df['processing_batch_id'] = 'etl_pipeline_230685'
            ...
            transformed_path = '/opt/airflow/data/temp/etl_pipeline_230685_transformed.parquet'
