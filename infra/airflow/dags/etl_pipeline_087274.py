...
def extract_data():
    ...
    try:
        ...
        temp_path = '/opt/airflow/data/temp/etl_pipeline_087274_extracted.parquet'
...
def transform_data():
    ...
    try:
        ...
        transformed_path = '/opt/airflow/data/temp/etl_pipeline_087274_transformed.parquet'
...
def load_data():
    ...
    try:
        ...
        if 'postgres' == 'postgres':
            ...
            output_path = f'/opt/airflow/data/output/etl_pipeline_087274_processed_data.parquet'
...
with DAG(
    ...
    description='Auto-generated ETL pipeline: etl_pipeline_087274',
