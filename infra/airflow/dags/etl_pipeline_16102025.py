...
def load_data():
    ...
    if not os.path.exists(transformed_path):
        raise FileNotFoundError(f"Файл с трансформированными данными не найден: /opt/airflow/data/temp/etl_pipeline_16102025_transformed.parquet")
...
# Определение DAG
with DAG(
    'etl_pipeline_16102025',
    default_args=default_args,
    description='Auto-generated ETL pipeline: etl_pipeline_16102025',
